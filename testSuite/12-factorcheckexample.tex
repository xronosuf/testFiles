...
\title{Runtime Test 12: Factoring Validation}

\begin{document}
\begin{abstract}
Tests the factorCheck validator.
\end{abstract}
\maketitle
...
\begin{problem}
The following should accept $(x+1)(x+2)(x+3)$ and not $(x^2+3x+2)(x+3)$, $x^3 + 6x^2 + 11x + 6$, or $(x^2 + 4x + 3)(x+2)$.

Factor $x^3 + 6x^2 + 11x + 6$
\[
a=\answer[validator=factorCheck]{(x+1)(x+2)(x+3)}
\]

\end{problem}

\begin{problem}
The following should accept $(x^2 + 3x + 2)(x + 3)$ or $(x^2 + 4x + 3)(x + 2)$, but not $(x+1)(x+2)(x+3)$ or $x^3 + 6x^2 + 11x + 6$ .

Factor $x^3 + 6x^2 + 11x + 6$
\[
a=\answer[validator=factorCheck]{(x^2 + 3x + 2)(x + 3)}
\]
